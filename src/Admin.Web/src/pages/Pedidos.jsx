                            ...
                            <tr key={pedido.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex space-x-2">
                                        <button onClick={() => handleOpenModal(pedido)} className="text-primary-600 hover:text-primary-800 font-medium">Editar</button>
                                        <button onClick={() => handleDeletePermanently(pedido.id)} className="text-red-600 hover:text-red-800 font-medium">Eliminar</button>
                                    </div>
                                </td>
                            </tr>
                        ))}
