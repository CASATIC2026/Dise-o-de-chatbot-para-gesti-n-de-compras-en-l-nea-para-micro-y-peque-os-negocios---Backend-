...
function Inventario() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingProduct) {
        await api.put(
          `/admin/inventario/productos/${editingProduct.id}`,
          dataToSave,
        );
  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-neutral-500 dark:text-neutral-400 mt-2">
            Gestiona tu catálogo de productos con facilidad
          </p>
        </div>
          ...
          <table className="w-full min-w-[980px] text-left border-collapse">
            <thead>
              <tr className="bg-neutral-50/50 dark:bg-dark-input/50 border-b border-neutral-200 dark:border-dark-border">
                {[
                  ...
                  <th
                    key={h}
                    className="px-6 py-4 text-xs font-bold text-neutral-500 dark:text-neutral-500 uppercase tracking-wider"
                  >
                    {h}
                  </th>
                ))}
            ...
            <tbody className="divide-y divide-neutral-100 dark:divide-dark-border">
              {productos.map((producto) => (
                <tr
                  key={producto.id}
                  className="hover:bg-neutral-50/50 dark:hover:bg-dark-input/50 transition-colors"
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-neutral-500 dark:text-neutral-500 font-medium truncate max-w-[200px]">
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`px-2.5 py-1 rounded-md text-xs font-bold border bg-neutral-50 dark:bg-dark-input text-neutral-700 dark:text-neutral-400 border-neutral-200 dark:border-dark-border`}
                    >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`px-2.5 py-1 rounded-md text-xs font-bold border ${producto.stockDisponible < 10 ? "bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 border-red-200 dark:border-red-800/30" : "bg-neutral-50 dark:bg-dark-input text-neutral-700 dark:text-neutral-400 border-neutral-200 dark:border-dark-border"}`}
                    >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${producto.activo ? "bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-400 border-green-200 dark:border-green-800/30" : "bg-neutral-100 dark:bg-dark-input text-neutral-600 dark:text-neutral-400 border-neutral-200 dark:border-dark-border"}`}
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full mr-1.5 ${producto.activo ? "bg-green-500" : "bg-neutral-400"}`}
                      ></span>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1.5">
                      <button
                        onClick={() =>
                          handleOpenImagePreview(producto.imagenUrl)
                        }
                        title="Ver Imagen"
          ...
          <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-xl dark:shadow-black/40 w-full max-w-md max-h-[90vh] flex flex-col overflow-hidden border border-neutral-100 dark:border-dark-border">
            <div className="p-6 border-b border-neutral-100 dark:border-dark-border flex justify-between items-center">
              ...
              <button
                ...
                className="text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 bg-neutral-50 dark:bg-dark-input hover:bg-neutral-100 dark:hover:bg-dark-border rounded-lg p-1.5 transition-colors"
              >
            ...
            <div className="p-6 overflow-y-auto">
              ...
              >
                <div>
                  ...
                  {hasError && (
                    <p className="mt-1.5 text-xs text-red-600 dark:text-red-400 font-medium flex items-center gap-1">
                      <AlertIcon className="w-4 h-4" /> Debe seleccionar una
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-400 dark:text-neutral-600 font-medium">
                        $
                      </span>
                      <input
                        type="number"
                ...
                <div className="flex items-center bg-neutral-50 dark:bg-dark-input p-3 rounded-xl border border-neutral-200 dark:border-dark-border">
                  ...
                  <label
                    htmlFor="activoCheck"
                    className="ml-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300 select-none cursor-pointer"
                  >
      ...
      {showImagePreview && (
        <div
          className="fixed inset-0 bg-neutral-900/80 dark:bg-black/90 backdrop-blur-sm flex items-center justify-center z-[60] p-4 animate-fade-in"
          onClick={handleCloseImagePreview}
        >
          <div
            className="relative bg-white dark:bg-dark-surface rounded-2xl p-2 max-w-2xl w-full shadow-2xl dark:shadow-black/60 border border-neutral-100 dark:border-dark-border"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              className="absolute -top-12 right-0 text-white/70 hover:text-white transition-colors bg-white/10 hover:bg-white/20 rounded-full w-10 h-10 flex items-center justify-center"
              onClick={handleCloseImagePreview}
            >
